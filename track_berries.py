...
def track_berries(world_coord_list, center_coords, start_frame_idx, last_frame_idx):
    ...
    return berry_cluster_idx_tracked, berry_pos_to_cluster, points_2d, frame_idx_array_list
...
if __name__ == "__main__":
    ...
    points_2d, frame_idx_array_list = track_berries(world_coord_list, center_coords, first_frame_idx, last_frame_idx)

    world_points, camera_indices, point_indexes_reassigned, points_2d = merge_tracked_data(berry_cluster_idx_tracked, berry_pos_to_cluster, points_2d, frame_idx_array_list)
